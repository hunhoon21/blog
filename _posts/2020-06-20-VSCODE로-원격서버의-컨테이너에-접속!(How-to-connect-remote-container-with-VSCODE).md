안녕하세요. 오늘은 원격서버에서 실행시킨 도커 컨테이너에 로컬에서 킨 VSCode로 접속해보는 방법에 대해 알아보도록 하겠습니다. 해당 글은 [여기](https://florian-kriegel.de/blog/?p=234) 를 참고했음을 알립니다. 여러분의 삽질에 도움이 되기를 바랍니다!
